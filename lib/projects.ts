...
export const projects: Project[] = [
  {
    ...
    projectId: "furever",
    features: [
      "Manage Pet Profiles with vaccinations",
    ...
    techStack: [
      ...
      "NextJS for frontend",
      "Typescript for scalability and debugging",
      "OpenStreetMap for Geo Services",
      "Diagflow from google for NLP assistant",
      "node-cron and nodemailer for reminder and email notification",
      "Next.js App Router for Routing",
      "Plain css for attractive design",
